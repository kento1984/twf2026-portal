"""本番 portal (CF Pages) を直接 Playwright で取得."""
...
TARGETS = [
    ("https://twf2026-portal.pages.dev/m/mesakku/", "PROD_after_proposal_mesakku"),
    ("https://twf2026-portal.pages.dev/m/robottobanku/", "PROD_after_proposal_robottobanku"),
]
